...
║                                                                                                                                              ║
║                                                                                                                                              ║
║  Enhanced AI clipboard assistant with command support for text processing and transformation.                                                   ║
║                                                                                                                                              ║
...
print("Initializing enhanced AI processor...")
try:
    llm = OpenAI()
    enhanced_processor = EnhancedProcessor(llm=llm)
    print("✅ Enhanced processor ready with command support!")
    print("   • Use <#command> syntax for advanced processing")
